...
const db = knex({
  ...
  connection: {
    ...
    database: process.env.POSTGRES_DB || "stellar_viaduct",
    user: process.env.POSTGRES_USER || "stellar_viaduct",
    password: process.env.POSTGRES_PASSWORD || "stellar_viaduct_dev",
  },
});
