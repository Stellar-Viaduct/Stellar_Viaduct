...
export async function sendExportEmail(
  ...
  try {
     const subject = `Your Stellar Viaduct Export is Ready`;
...
<body>
  ...
  <div class="content">
    <p>Your Stellar Viaduct data export has been successfully generated and is ready for download.</p>
  ...
  <div class="footer">
    <p>Stellar Viaduct - Cross-Chain Bridge Monitoring</p>
...
function generateEmailText(exportRecord: ExportRecord): string {
  ...
  return `
Your Stellar Viaduct Export is Ready!
...
---
Stellar Viaduct - Cross-Chain Bridge Monitoring
