...
export class DiscordService {
  ...
  private createAlertEmbed(alert: DiscordAlert): EmbedBuilder {
    ...
    const embed = new EmbedBuilder()
      ...
      .setFooter({ text: "Stellar Viaduct Alert" });
  ...
  private registerCommands(): void {
    this.commands = [
      {
        name: "subscribe",
        description: "Subscribe to Stellar Viaduct alerts",
        execute: this.handleSubscribe.bind(this),
      },
      {
        name: "unsubscribe",
        description: "Unsubscribe from Stellar Viaduct alerts",
        execute: this.handleUnsubscribe.bind(this),
      },
      {
        name: "status",
        description: "Get Stellar Viaduct system status",
  ...
  private updatePresence(): void {
    if (this.client.user) {
      this.client.user.setActivity("Stellar Viaduct", { type: ActivityType.Watching });
    }
  }
  ...
  private async handleStatus(interaction: any): Promise<void> {
    try {
      ...
      const embed = new EmbedBuilder()
        .setTitle("Stellar Viaduct Status")
        .setColor(0x00ff00)
        .addFields(
        ...
        .setTimestamp()
        .setFooter({ text: "Stellar Viaduct" });
