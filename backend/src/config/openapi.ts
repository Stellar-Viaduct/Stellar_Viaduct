...
export const swaggerOptions: FastifyDynamicSwaggerOptions = {
  openapi: {
    openapi: "3.0.3",
    info: {
      title: "Stellar Viaduct API",
      description: `
## Overview
Stellar Viaduct is a real-time Stellar bridge monitoring platform. This API provides access to
...
\`\`\`
      ...
      version: "1.0.0",
      contact: {
        name: "Stellar Viaduct Team",
        url: "https://github.com/Stellar_Viaduct/Stellar_Viaduct",
      },
      license: {
        name: "MIT",
    ...
    servers: [
      ...
      {
        url: "https://api.stellarviaduct.io",
