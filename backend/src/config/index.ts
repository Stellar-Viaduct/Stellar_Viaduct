...
const envSchema = z.object({
  ...
  POSTGRES_DB: z.string().default("stellar_viaduct"),
  POSTGRES_USER: z.string().default("stellar_viaduct"),
  POSTGRES_PASSWORD: z.string().default("stellar_viaduct_dev"),
  ...
  SMTP_FROM_ADDRESS: z.string().default("noreply@stellarviaduct.io"),
  SMTP_FROM_NAME: z.string().default("Stellar Viaduct"),
  ...
  HEALTH_SCORE_DROP_THRESHOLD: z.coerce.number().default(0.5),
