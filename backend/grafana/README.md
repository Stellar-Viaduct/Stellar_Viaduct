# Grafana Dashboards for Stellar Viaduct

This directory contains Grafana dashboard templates and provisioning configurations for monitoring the Stellar Viaduct application.
