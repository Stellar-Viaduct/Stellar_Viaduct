...
This document describes the Telegram bot integration for Stellar Viaduct, providing real-time alert delivery, subscription management, and admin commands via Telegram.
...
# Production
TELEGRAM_WEBHOOK_URL=https://stellar-viaduct.example.com/api/v1/telegram/webhook
...
[View Details](https://stellar-viaduct.example.com/alerts/rule-456)
```
...
1. **User Account Linking:** Link Telegram users to Stellar Viaduct users for role-based access
...
- [Stellar Viaduct Architecture](../docs/)
