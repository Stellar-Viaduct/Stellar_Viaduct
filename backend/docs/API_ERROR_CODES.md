...
This document provides a comprehensive list of error codes returned by the Stellar Viaduct API, along with their meanings, causes, and recommended client actions.
