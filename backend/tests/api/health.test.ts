...
describe("Health Check Endpoints", () => {
  ...
  describe("GET /health/metrics", () => {
    it("should return Prometheus-style metrics", async () => {
      ...
      expect(payload).toContain("# HELP viaduct_health_status");
      expect(payload).toContain("# TYPE viaduct_health_status gauge");
      expect(payload).toContain("viaduct_health_status{component=\"database\"}");
      expect(payload).toContain("viaduct_health_status{component=\"redis\"}");
      expect(payload).toContain("viaduct_health_status{component=\"external_apis\"}");
      expect(payload).toContain("viaduct_health_status{component=\"system\"}");
      expect(payload).toContain("viaduct_health_status{component=\"overall\"}");
      
      expect(payload).toContain("# HELP viaduct_uptime_seconds");
      expect(payload).toContain("# TYPE viaduct_uptime_seconds counter");
      expect(payload).toContain("viaduct_uptime_seconds");
      
      expect(payload).toContain("# HELP viaduct_health_check_duration_seconds");
      expect(payload).toContain("# TYPE viaduct_health_check_duration_seconds gauge");
      expect(payload).toContain("viaduct_health_check_duration_seconds{component=\"database\"}");
    });
  });
});
