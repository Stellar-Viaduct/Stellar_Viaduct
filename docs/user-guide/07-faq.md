...
### What is Stellar Viaduct?

Stellar Viaduct is an open-source monitoring platform for cross-chain asset bridges, DEX liquidity, and bridged asset health on the Stellar network. It provides real-time analytics, automated alerts, and transparent reporting.

### Is Stellar Viaduct free to use?
...
1. Check if it's already reported in [GitHub Issues](https://github.com/Stellar_Viaduct/Stellar_Viaduct/issues)
...
3. Search [GitHub Issues](https://github.com/Stellar_Viaduct/Stellar_Viaduct/issues)
...
1. Email security@stellarviaduct.io
2. Include detailed description
3. We'll respond within 48 hours

---

Still have questions? [Open an issue on GitHub](https://github.com/Stellar_Viaduct/Stellar_Viaduct/issues) or join our Discord community.
