...
This guide covers deploying Stellar Viaduct using Docker and Docker Compose for development and production environments.

## Architecture

Stellar Viaduct uses a multi-container architecture with Docker Compose:
...
All services communicate over a single bridge network (`stellar-viaduct`). Service names are used as hostnames:
