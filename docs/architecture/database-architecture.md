...
Schema design, data model, and TimescaleDB strategy for Stellar Viaduct.

## Overview

Stellar Viaduct uses **PostgreSQL 15+** with the **TimescaleDB** extension. The schema separates data into two categories:
