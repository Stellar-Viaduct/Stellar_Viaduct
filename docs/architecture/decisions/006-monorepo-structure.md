...
Stellar Viaduct consists of three major components: a Node.js/TypeScript backend, a React/TypeScript frontend, and Rust/Soroban smart contracts. These components share configuration, documentation, and CI/CD pipelines. The team needed to decide how to organize the source code.
