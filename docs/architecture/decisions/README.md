...
This directory contains Architecture Decision Records (ADRs) for Stellar Viaduct. ADRs document significant architectural decisions, their context, and rationale.
