...
Stellar Viaduct's frontend needs global state management for bridge data, user preferences, alert configurations, and real-time WebSocket data. The state management solution must handle frequent real-time updates without excessive re-renders.
