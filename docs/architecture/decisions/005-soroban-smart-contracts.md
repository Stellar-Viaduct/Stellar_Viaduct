...
- **Native Stellar integration:** Soroban runs natively on Stellar, the primary blockchain monitored by Stellar Viaduct. No bridging or cross-chain calls needed.
