...
High-level architecture of Stellar Viaduct, describing the major components and their interactions.

## Architecture Pattern

Stellar Viaduct follows a **multi-tier architecture** with event-driven processing:
...
The backend is the core of Stellar Viaduct, providing:
...
|----------|---------------|
| **Stellar Viaduct Core** | Asset registry, health scoring, deviation alerts, circuit breaker |
