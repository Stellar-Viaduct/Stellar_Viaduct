...
Design and structure of the Stellar Viaduct smart contracts deployed on Soroban.

## Overview

Stellar Viaduct includes two Soroban smart contract packages:

| Contract | Crate | Purpose |
|----------|-------|---------|
| **Stellar Viaduct Core** | `contracts/soroban/` | Asset registry, health scoring, alerts, circuit breaker |
