...
Security model, authentication, authorization, and threat mitigation for Stellar Viaduct.
...
- All services communicate on a private `stellar-viaduct` network
...
Security vulnerabilities should be reported via email to **security@stellarviaduct.io** — not through public issues. See [CONTRIBUTING.md](../../CONTRIBUTING.md) for the responsible disclosure policy.
