...
External service integrations and data source connections for Stellar Viaduct.

## Overview

Stellar Viaduct integrates with multiple external systems to collect, verify, and enrich monitoring data:

```
┌─────────────────────────────────────────────────────────────────┐
│                     Stellar Viaduct Backend                        │
│                                                                 │
│  ┌───────────────────────────────────────────────────────────┐  │
│  │                   Integration Layer                       │  │
│  │                                                           │  │
...
Stellar Viaduct aggregates liquidity across multiple Stellar DEXes:
