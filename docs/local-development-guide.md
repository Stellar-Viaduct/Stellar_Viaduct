...
This guide walks you through running the full Stellar Viaduct stack locally, from first clone to a working dev environment.
...
git clone https://github.com/<your-username>/Stellar-Viaduct.git
cd stellar-viaduct
