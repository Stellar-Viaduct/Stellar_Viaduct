...
| Term | Definition |
|------|-----------|
| **Stellar Viaduct** | Open-source monitoring platform for cross-chain asset bridges, DEX liquidity, and bridged asset health on the Stellar network. |
...
| **Stellar Viaduct SDK** | TypeScript SDK (`@stellar-viaduct/contract-sdk`) for integrating Soroban contracts with the monitoring platform. |
...
| **API Key** | An authentication credential for programmatic access to the Stellar Viaduct API. |
