...
```bash
curl -X POST https://api.stellarviaduct.io/api/assets/RISKY/freeze \
...
```bash
# Before
curl -X POST https://api.stellarviaduct.io/api/assets/USDC/risk \
...
- **API Documentation**: https://docs.stellarviaduct.io/api
- **Status Page**: https://status.stellarviaduct.io
- **Support**: https://support.stellarviaduct.io
- **Issues**: https://github.com/Stellar_Viaduct/Stellar_Viaduct/issues
