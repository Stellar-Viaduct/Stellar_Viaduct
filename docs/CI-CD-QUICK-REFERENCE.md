...
| ----------- | ------------------------------------- | ------- | -------- |
| Staging     | https://staging.stellarviaduct.io | develop | None     |
| Production  | https://stellarviaduct.io         | main    | Required |
...
# Pull latest
docker pull ghcr.io/stellar_viaduct/stellar-viaduct/backend:latest
docker pull ghcr.io/stellar_viaduct/stellar-viaduct/frontend:latest

# Pull specific version
docker pull ghcr.io/stellar_viaduct/stellar-viaduct/backend:v1.0.0
```
