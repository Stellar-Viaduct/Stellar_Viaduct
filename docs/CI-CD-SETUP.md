...
This document provides a comprehensive guide to the CI/CD pipeline implementation for Stellar Viaduct using GitHub Actions.
...
2. Name: `staging`
3. Environment URL: `https://staging.stellarviaduct.io`
...
1. Click "New environment"
2. Name: `production`
3. Environment URL: `https://stellarviaduct.io`
4. Protection rules:
...
This CI/CD pipeline provides a robust, automated workflow for developing and deploying Stellar Viaduct. It ensures code quality, security, and reliability while enabling rapid iteration and deployment.
