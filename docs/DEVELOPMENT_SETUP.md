...
This guide covers setting up the Stellar Viaduct development environment from scratch. You can use the **automated setup script** or follow the manual steps below.
...
git clone https://github.com/Stellar_Viaduct/Stellar_Viaduct.git
cd stellar-viaduct
...
│   ├── soroban/        # Main Stellar Viaduct contract
...
| PostgreSQL      | localhost:5432               | stellar_viaduct / stellar_viaduct_dev  |
...
**"stellar-viaduct-postgres" container keeps restarting**

```bash
# Check logs
docker logs stellar-viaduct-postgres
...
**"role stellar_viaduct does not exist" or error code 28000**
...
**"database stellar_viaduct does not exist"**
...
- The repo should be cloned inside the WSL2 filesystem (e.g., `~/projects/stellar-viaduct`) for best performance — avoid `/mnt/c/`
