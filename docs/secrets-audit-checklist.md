...
Periodic review of secrets usage, scope, rotation readiness, and exposure for the Stellar Viaduct platform.
...
- [ ] Kubernetes RBAC limits who can read `stellar-viaduct-secrets` (see [kubernetes-deployment.md](./deployment/kubernetes-deployment.md)).
