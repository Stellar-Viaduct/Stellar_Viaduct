...
How list endpoints paginate in the Stellar Viaduct REST API (`/api/v1/`).

## Overview

Stellar Viaduct uses **three pagination models**. Always read the endpoint you integrate with — parameter names and response shapes are not fully standardized yet.
