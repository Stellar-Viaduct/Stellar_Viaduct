...
stellar-viaduct uses **Vitest** (backend and frontend), **Playwright** (E2E), and **Cargo test** (Soroban contracts). There is no pytest or `conftest.py`; shared test data lives in layered fixtures:
