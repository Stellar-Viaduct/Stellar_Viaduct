...
The Circuit Health API provides comprehensive health information for alerting and protection circuits used by the stellar-viaduct platform. This API enables real-time monitoring of circuit breaker states, recent transitions, manual overrides, and cache performance.
