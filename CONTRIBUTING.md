# Contributing to Stellar Viaduct

First off — **thank you** for taking the time to contribute! 🎉

Stellar Viaduct is a premium open-source project and we welcome contributions of every kind: code, documentation, bug reports, design, testing, and community support. No contribution is too small. Whether you're fixing a typo, writing tests, or building a major feature, you're helping make Stellar's cross-chain ecosystem safer and more transparent for everyone.
...
This project follows our [Code of Conduct](CODE_OF_CONDUCT.md). By participating, you agree to uphold it. Please read it — it's short and ensures Stellar Viaduct remains a welcoming place for everyone.

Report unacceptable behaviour to **security@stellarviaduct.io**. All reports are handled confidentially.
...
Before opening a new issue or starting work, search the [issue tracker](https://github.com/Stellar_Viaduct/Stellar_Viaduct/issues) to make sure the problem or idea hasn't already been raised. A quick search saves everyone time.
...
git clone https://github.com/YOUR_USERNAME/Stellar-Viaduct.git
cd Stellar-Viaduct

# 2. Add upstream remote
git remote add upstream https://github.com/Stellar_Viaduct/Stellar_Viaduct.git
...
| PgAdmin | http://localhost:5050 | admin@stellarviaduct.io / admin |
...
**Do not open a public issue for security vulnerabilities.** Email **security@stellarviaduct.io** with details. We follow responsible disclosure — you'll receive a response within 48 hours and public credit once the fix is released (if you want it).
...
# 6. Open a PR against Stellar_Viaduct/Stellar_Viaduct main
```
...
Stellar Viaduct uses [Semantic Versioning](https://semver.org/) (`MAJOR.MINOR.PATCH`).
...
| Channel | Purpose |
|---------|---------|
| [GitHub Issues](https://github.com/Stellar_Viaduct/Stellar_Viaduct/issues) | Bug reports, feature requests, tasks |
| [GitHub Discussions](https://github.com/Stellar_Viaduct/Stellar_Viaduct/discussions) | Questions, ideas, general conversation |
| **security@stellarviaduct.io** | Security vulnerability reports (private) |
...
[GitHub Discussion](https://github.com/Stellar_Viaduct/Stellar_Viaduct/discussions) — other community members may have encountered the same issue.
...
*Thank you for contributing to Stellar Viaduct. Every pull request, every bug report, every documentation improvement makes the Stellar ecosystem a little bit better.* 🌟
