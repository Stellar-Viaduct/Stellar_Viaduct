...
psql:
	docker exec -it stellar-viaduct-postgres \
	  psql -U $${POSTGRES_USER:-stellar_viaduct} $${POSTGRES_DB:-stellar_viaduct}
...
## Open a Redis CLI
redis-cli:
	docker exec -it stellar-viaduct-redis redis-cli
...
help:
	@echo ""
	@echo "Stellar Viaduct — available make targets:"
	@echo ""
	...
	@echo "  PgAdmin    http://localhost:5050  (admin@stellarviaduct.io / admin)"
