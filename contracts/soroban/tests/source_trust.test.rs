...
use stellar_viaduct_contracts::{StellarViaductContract, StellarViaductContractClient};

fn setup() -> (
    Env,
    StellarViaductContractClient<'static>,
    Address,
    Address,
    Address,
) {
...
fn test_submit_health_requires_trusted_source_when_sources_registered() {
    ...
    client.grant_role(
        &admin,
        &trusted_source,
        stellar_viaduct_contracts::AdminRole::HealthSubmitter,
    );
    client.grant_role(
        &admin,
        &untrusted_source,
...
fn test_submit_price_requires_trusted_source_when_sources_registered() {
    ...
    client.grant_role(
        &admin,
        &trusted_source,
        stellar_viaduct_contracts::AdminRole::PriceSubmitter,
    );
    client.grant_role(
        &admin,
        &untrusted_source,
