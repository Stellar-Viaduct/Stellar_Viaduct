...
This repo includes **reusable Grafana dashboard templates** that can be imported into any Grafana instance connected to a Prometheus scraping Stellar Viaduct metrics.
...
Stellar Viaduct backend exports Prometheus metrics on `GET /metrics`.
...
- `monitoring/grafana/screenshots/viaduct-system-overview.svg`
- `monitoring/grafana/screenshots/viaduct-alert-volume.svg`
- `monitoring/grafana/screenshots/viaduct-service-health.svg`
- `monitoring/grafana/screenshots/viaduct-historical-trends.svg`
