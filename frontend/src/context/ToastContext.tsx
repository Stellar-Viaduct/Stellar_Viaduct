          ...
          className={`pointer-events-auto rounded-lg border px-4 py-3 shadow-lg backdrop-blur-sm ${
            t.variant === "error"
              ...
              : t.variant === "success"
                ...
                : "border-viaduct-border bg-viaduct-card/95 text-viaduct-text-primary"
          }`}
        >
          <div className="flex items-start justify-between gap-3">
            ...
            <button
              ...
              className="shrink-0 rounded p-0.5 text-current opacity-70 hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-viaduct-accent"
