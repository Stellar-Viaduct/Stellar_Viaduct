...
const viaductLight: ThemeColors = {
  primary: "#6366f1",
  secondary: "#6b7280",
  accent: "#8b5cf6",
  background: "#fafbfe",
...
export const THEME_PRESETS: ThemePresetDefinition[] = [
  {
    id: "viaduct",
    label: "Stellar Viaduct",
    description: "Premium indigo palette with refined contrast — the default Stellar Viaduct identity.",
    light: { ...viaductLight },
    dark: { ...viaductDark },
    font: { family: "Inter, system-ui, sans-serif", size: "md", lineHeight: "normal" },
    density: "comfortable",
  },
  {
    id: "stellar",
    label: "Stellar Classic",
    description: "Blue / violet balance from the original palette.",
    light: { ...baseLight },
    dark: { ...baseDark },
  },
  {
