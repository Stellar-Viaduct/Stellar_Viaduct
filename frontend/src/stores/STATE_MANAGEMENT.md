...
This document describes the centralized state management solution for Stellar Viaduct using Zustand.
...
- **User Preferences Store** - `stellar-viaduct-user-preferences`
- **Theme Store** - `stellar-viaduct-theme`
