...
function ActionButton({
  ...
  const baseClass =
    "group relative inline-flex items-center gap-2 rounded-lg border px-3 py-1.5 text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-viaduct-accent disabled:cursor-not-allowed disabled:opacity-40";

  const variantClass =
    action.variant === "primary"
      ? "border-viaduct-accent bg-viaduct-accent/15 text-viaduct-accent hover:bg-viaduct-accent hover:text-white"
