...
export default function TopMovers({ movers, isLoading, period }: TopMoversProps) {
  ...
  if (movers.length === 0) {
    return (
      <div className="bg-viaduct-card border border-viaduct-border rounded-lg p-6">
        ...
        <p className="text-viaduct-text-secondary text-sm">No data available</p>
      </div>
    );
  }
  ...
  return (
    <div className="bg-viaduct-card border border-viaduct-border rounded-lg p-6">
      ...
      <p className="text-xs text-viaduct-text-secondary mb-4">Health score change over {period}</p>
        ...
        <div>
          ...
          <div className="divide-y divide-viaduct-border">
            {gainers.length > 0 ? (
              ...
              <p className="py-3 text-sm text-viaduct-text-secondary">No gainers</p>
            )}
          </div>
        </div>
        ...
        <div>
          ...
          <div className="divide-y divide-viaduct-border">
            {losers.length > 0 ? (
              ...
              <p className="py-3 text-sm text-viaduct-text-secondary">No losers</p>
            )}
          </div>
        </div>
      </div>
