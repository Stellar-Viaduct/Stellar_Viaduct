    ...
    <div className="bg-viaduct-card border border-viaduct-border rounded-lg p-6">
      <div className="flex items-center justify-between mb-1">
        ...
        <div className="flex items-center gap-3">
          {bridges.map((b) => (
            <span key={b.name} className="flex items-center gap-1 text-xs text-viaduct-text-secondary">
              <span
      ...
      <p className="text-xs text-viaduct-text-secondary mb-4">TVL · 24h Volume · 7d Volume</p>
