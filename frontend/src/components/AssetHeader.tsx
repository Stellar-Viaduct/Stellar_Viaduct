...
function getTrendColor(trend: string | null): string {
  ...
  return "text-viaduct-text-secondary";
}
  ...
  return (
    <div className="bg-viaduct-card border border-viaduct-border rounded-lg p-6">
      <div className="flex items-center gap-2 mb-4">
        <Link
          to="/"
          className="text-sm text-viaduct-text-secondary hover:text-white transition-colors"
        >
          Dashboard
        </Link>
        <span className="text-viaduct-text-secondary">/</span>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-3 flex-wrap">
            ...
            {assetInfo && (
              <span className="px-2.5 py-0.5 rounded-full text-xs font-medium bg-stellar-border text-viaduct-text-secondary">
        ...
        {score !== null && (
          <div className="flex flex-col items-center flex-shrink-0">
            ...
            <span className="text-xs text-viaduct-text-secondary">Health Score</span>
            {health?.trend && (
              <span
      ...
      {assetInfo?.issuer && (
        <div className="mt-4 pt-4 border-t border-viaduct-border">
          <div className="flex flex-wrap gap-x-6 gap-y-2 text-sm">
            ...
            {health?.lastUpdated && (
              <div>
                <span className="text-viaduct-text-secondary">Last updated: </span>
