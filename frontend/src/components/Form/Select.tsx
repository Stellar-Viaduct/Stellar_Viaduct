        ...
        const selectElement = (
            <div className="relative">
                <select
                    ...
                    className={`w-full bg-viaduct-background border rounded-md px-3 py-2 text-sm text-white appearance-none transition-all focus:outline-none focus:ring-2
            ${hasError ? "border-red-500 focus:ring-red-500/50" : "border-viaduct-border focus:ring-viaduct-accent/50"}
            ...
            ${className}`}
                ...
                <div className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none">
                    {loading ? (
                        <div className="w-4 h-4 border-2 border-viaduct-accent border-t-transparent rounded-full animate-spin" />
                    ) : (
                        <svg
                            className="w-4 h-4 text-viaduct-text-secondary"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                        >
