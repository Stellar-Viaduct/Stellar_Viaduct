        ...
        const inputElement = (
            <div className="relative">
                <input
                    ...
                    className={`w-full bg-viaduct-background border rounded-md px-3 py-2 text-sm text-white transition-all focus:outline-none focus:ring-2 focus:ring-viaduct-accent
