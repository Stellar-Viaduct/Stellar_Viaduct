            ...
            ${disabled ? "opacity-60 cursor-not-allowed" : ""}`}
                >
                    <div className="relative flex items-center mt-0.5">
                        ...
                        />
                        <div
                            className={`w-5 h-5 rounded border bg-viaduct-background transition-all
                group-hover:border-stellar-text-secondary
                peer-focus-visible:ring-2 peer-focus-visible:ring-viaduct-accent/50
                peer-checked:bg-viaduct-accent peer-checked:border-viaduct-accent
                ${hasError ? "border-red-500" : "border-viaduct-border"}`}
                        >
                            <svg
                ...
                ${disabled ? "text-viaduct-text-secondary" : "text-viaduct-text-primary"}`}
                        >
                            {label}
                            {required && (
