...
export default function TimelineFilters({
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex gap-2">
        <div className="flex-grow relative">
          <input
            ...
            className="w-full bg-viaduct-card border border-viaduct-border rounded px-3 py-2 pl-9 text-sm text-white placeholder-stellar-text-muted focus:outline-none focus:border-viaduct-accent"
        ...
        <button
          ...
          className="px-4 py-2 bg-viaduct-card border border-viaduct-border rounded text-sm text-white hover:bg-viaduct-card-hover transition-colors flex items-center gap-2"
        ...
        >
          ...
          Filters
          {activeFilterCount > 0 && (
            <span className="bg-viaduct-accent text-white text-xs font-bold px-1.5 py-0.5 rounded-full">
              {activeFilterCount}
            </span>
          )}
        </button>
        ...
        {activeFilterCount > 0 && (
          <button
            ...
            className="px-4 py-2 bg-viaduct-card border border-viaduct-border rounded text-sm text-red-400 hover:bg-viaduct-card-hover transition-colors"
      ...
      {/* Expanded filters */}
      {isExpanded && (
        <div className="bg-viaduct-card border border-viaduct-border rounded-lg p-4 space-y-4">
          {/* Event types */}
          <div>
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded text-sm font-medium transition-colors ${
                    filters.types?.includes(type.value)
                      ...
                      : "bg-viaduct-card border border-viaduct-border text-viaduct-text-secondary hover:bg-viaduct-card-hover"
                  }`}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                className="w-full bg-viaduct-card border border-viaduct-border rounded px-3 py-1.5 text-sm text-white placeholder-stellar-text-muted focus:outline-none focus:border-viaduct-accent"
              />
            </div>
