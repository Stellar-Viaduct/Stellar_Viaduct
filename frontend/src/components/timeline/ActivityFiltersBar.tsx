...
export default function ActivityFiltersBar({
  ...
  return (
    <div className="rounded-lg border border-viaduct-border bg-viaduct-card p-3">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-end">
        <div className="grid flex-1 grid-cols-1 gap-3 sm:grid-cols-3">
          <div>
            <label
              htmlFor="activity-time-filter"
              className="mb-1 block text-xs font-medium uppercase text-viaduct-text-secondary"
            >
              Time
            </label>
            <select
              ...
              className="min-h-10 w-full rounded-md border border-viaduct-border bg-viaduct-background px-3 text-sm text-viaduct-text-primary focus:outline-none focus-visible:ring-2 focus-visible:ring-viaduct-accent"
            >
        ...
        <div className="flex flex-col gap-3 sm:flex-row lg:w-[24rem]">
          ...
          <button
            ...
            onClick={onReset}
            disabled={!active}
            className="min-h-10 rounded-md border border-viaduct-border px-4 text-sm font-medium text-viaduct-text-primary transition-colors hover:border-viaduct-accent hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-viaduct-accent disabled:cursor-not-allowed disabled:opacity-50"
          >
            Reset
          </button>
        </div>
