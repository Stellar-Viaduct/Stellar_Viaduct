  ...
  return (
    <button
      ...
      className={
        ...
        (active
          ? "border-viaduct-border bg-viaduct-card text-viaduct-text-primary"
          : "border-viaduct-border/60 bg-transparent text-viaduct-text-secondary")
      }
      aria-pressed={active}
    >
      {label}
          ...
          <div className="flex flex-wrap items-center gap-2">
            <label className="flex items-center gap-2 text-xs text-viaduct-text-secondary">
              ...
              <input
                ...
                className="rounded-md border border-viaduct-border bg-transparent px-2 py-1 text-xs text-viaduct-text-primary"
              />
            </label>
            <label className="flex items-center gap-2 text-xs text-viaduct-text-secondary">
              <span>To</span>
      ...
      <div className="flex flex-wrap items-center gap-4">
        <label className="flex items-center gap-2 text-xs text-viaduct-text-secondary">
          ...
          <input
            ...
            className="w-20 rounded-md border border-viaduct-border bg-transparent px-2 py-1 text-xs text-viaduct-text-primary"
          />
          <span>%</span>
        </label>
        ...
        <button
          type="button"
          onClick={onExportPng}
          className="rounded-md border border-viaduct-border bg-viaduct-card px-3 py-1.5 text-xs text-viaduct-text-primary"
        >
          Export PNG
        </button>
      </div>
