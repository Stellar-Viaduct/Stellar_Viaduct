...
export default function HamburgerButton({
  ...
  return (
    <button
      ...
      className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-viaduct-border bg-viaduct-card/90 text-white shadow-lg shadow-black/20 transition hover:border-viaduct-accent hover:text-viaduct-accent focus:outline-none focus:ring-2 focus:ring-viaduct-accent md:hidden"
    >
