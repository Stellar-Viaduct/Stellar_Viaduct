  ...
  return (
    <div className="rounded-lg border border-viaduct-border bg-viaduct-card p-4">
      ...
      <div className="mt-3 grid gap-4 md:grid-cols-2">
        <label className="flex flex-col gap-2 text-sm text-viaduct-text-secondary">
          Refresh interval
          <select
            value={refreshIntervalMs}
            onChange={(event) => onRefreshIntervalChange(Number(event.target.value))}
            className="rounded-md border border-viaduct-border bg-viaduct-background px-2 py-2 text-white"
          >
        ...
        <label className="inline-flex items-center gap-2 self-end text-sm text-viaduct-text-secondary">
          <input
            type="checkbox"
      ...
      <fieldset className="mt-4">
        <legend className="text-sm text-viaduct-text-secondary">Refresh scope</legend>
