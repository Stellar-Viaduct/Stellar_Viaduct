...
export default function RefreshControls({
  ...
  return (
    <div className="space-y-3 rounded-lg border border-viaduct-border bg-viaduct-card/50 p-4">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <span className="text-xs text-viaduct-text-secondary">Last updated: {formatTimestamp(lastUpdatedAt)}</span>
      </div>
