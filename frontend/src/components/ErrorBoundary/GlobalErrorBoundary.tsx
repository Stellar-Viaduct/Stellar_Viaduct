...
> {
  ...
  render() {
    if (this.state.hasError && this.state.error) {
      return (
        <div className="min-h-screen bg-viaduct-background flex items-center justify-center p-4">
          <div className="max-w-lg w-full">
            <ErrorFallback
              ...
              message="Stellar Viaduct encountered an unexpected error. You can try again or reload the page."
            />
          </div>
        </div>
      );
