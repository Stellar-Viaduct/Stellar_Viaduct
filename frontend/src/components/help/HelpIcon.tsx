...
export default function HelpIcon({
  ...
  const defaultTrigger = (
    <button
      ...
      className={`inline-flex items-center justify-center rounded-full border border-viaduct-border
        text-viaduct-text-secondary bg-transparent
        hover:border-viaduct-accent hover:text-viaduct-accent
        focus:outline-none focus:ring-2 focus:ring-viaduct-accent focus:ring-offset-1 focus:ring-offset-stellar-card
