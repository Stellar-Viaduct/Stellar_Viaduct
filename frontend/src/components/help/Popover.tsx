      ...
      {open &&
        createPortal(
          <div
            ...
            className={`relative rounded-lg border border-viaduct-border bg-viaduct-card shadow-xl text-xs text-viaduct-text-primary p-3 ${maxWidth} ${className}`}
          >
            {/* Directional arrow */}
            <span
            ...
            {title && (
              <p className="font-semibold text-viaduct-text-primary mb-1">{title}</p>
            )}

            <div className="text-viaduct-text-secondary leading-relaxed">{content}</div>
            ...
            {link && (
              <a
                ...
                className="mt-2 inline-flex items-center gap-1 text-viaduct-accent hover:underline focus:outline-none focus:ring-1 focus:ring-viaduct-accent rounded"
