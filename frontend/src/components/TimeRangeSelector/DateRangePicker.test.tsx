...
describe("DateRangePicker", () => {
  ...
  describe("Preset Selection", () => {
    ...
    it("indicates active preset", () => {
      ...
      expect(button).toHaveClass("bg-viaduct-accent");
    });
    ...
    it("indicates inactive presets", () => {
      ...
      expect(button).not.toHaveClass("bg-viaduct-accent");
    });
  });
  ...
  describe("Recent Ranges", () => {
    ...
    it("stores up to 5 recent ranges", async () => {
      ...
      const stored = JSON.parse(localStorage.getItem("stellarviaduct.recentRanges.v1") || "[]");
    ...
    it("applies recent range when clicked", async () => {
      ...
      localStorage.setItem("stellarviaduct.recentRanges.v1", JSON.stringify([recentRange]));
    ...
    it("does not store presets as recent ranges", async () => {
      ...
      const stored = localStorage.getItem("stellarviaduct.recentRanges.v1");
