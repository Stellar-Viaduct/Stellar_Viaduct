...
const DEFAULT_INACTIVE =
  "border-viaduct-border text-viaduct-text-secondary hover:border-viaduct-accent hover:text-white";
const DEFAULT_DISABLED =
  "border-viaduct-border text-viaduct-text-secondary opacity-40 cursor-not-allowed";
  ...
  return (
    <button
      ...
      className={[
        ...
        "focus:outline-none focus-visible:ring-2 focus-visible:ring-viaduct-accent focus-visible:ring-offset-2 focus-visible:ring-offset-stellar-card",
...
export function TabPanel({
  ...
  return (
    <div
      ...
      tabIndex={0}
      className={[
        "focus:outline-none focus-visible:ring-2 focus-visible:ring-viaduct-accent rounded",
        className,
      ]
        .filter(Boolean)
        .join(" ")}
