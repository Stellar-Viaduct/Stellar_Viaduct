  ...
  return (
    <div className="space-y-4">
      <div>
        <label
          htmlFor="trade-size"
          className="block text-xs text-viaduct-text-secondary mb-1"
        >
        ...
        <div className="relative">
          <input
            ...
            className="w-full bg-viaduct-background border border-viaduct-border rounded-md px-3 py-2 text-sm text-white placeholder-stellar-text-secondary focus:outline-none focus:ring-2 focus:ring-viaduct-accent"
          />
          {depth && (
            <div className="absolute right-3 top-2 text-xs text-viaduct-text-secondary">
              {depth.pair.split("/")[1]}
            </div>
          )}
        </div>
      ...
      {result && (
        <>
          <dl className="space-y-3 text-sm bg-viaduct-background/50 p-4 rounded-lg border border-viaduct-border/50">
            <div className="flex justify-between">
              <dt className="text-viaduct-text-secondary">Expected Price</dt>
              <dd className="text-white font-mono">{result.expectedPrice.toFixed(7)}</dd>
            </div>
            <div className="flex justify-between items-center">
              <dt className="text-viaduct-text-secondary">Price Impact / Slippage</dt>
            ...
            <div className="flex justify-between">
              <dt className="text-viaduct-text-secondary">Fillable Liquidity</dt>
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 text-xs text-viaduct-accent hover:text-viaduct-accent-light transition-colors text-left"
            >
          ...
          {showExplanation && (
            <div className="text-xs text-viaduct-text-secondary leading-relaxed bg-viaduct-background/30 p-3 rounded border border-viaduct-border/30">
              <p className="mb-2">
      ...
      {!depth && (
        <p className="text-xs text-viaduct-text-secondary animate-pulse">
