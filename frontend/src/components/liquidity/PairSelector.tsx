  ...
  return (
    <div className="flex items-center gap-3">
      <label
        ...
        className="text-sm text-viaduct-text-secondary whitespace-nowrap"
      >
        Trading Pair
      </label>
      <select
        ...
        className="bg-viaduct-background border border-viaduct-border rounded-md px-3 py-1.5 text-sm text-white focus:outline-none focus:ring-2 focus:ring-viaduct-accent"
      >
