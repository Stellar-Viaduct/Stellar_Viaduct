...
const CustomTooltip = ({ active, payload, label }: CustomTooltipProps) => {
  ...
  return (
    <div className="bg-viaduct-background border border-viaduct-border rounded-lg p-3 text-xs shadow-lg">
      <p className="text-viaduct-text-secondary mb-1">Price: {label?.toFixed(7)}</p>
      {payload.map((p) => (
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="flex items-center gap-2 text-xs text-viaduct-text-secondary">
