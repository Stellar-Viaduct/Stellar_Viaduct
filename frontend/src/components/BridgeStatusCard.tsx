  ...
  return (
    <div className="relative">
      ...
      <Link
        ...
        className={`block bg-viaduct-card border border-viaduct-border rounded-lg hover:border-viaduct-accent transition-colors focus:outline-none focus:ring-2 focus:ring-viaduct-accent focus:ring-offset-2 focus:ring-offset-stellar-dark ${
      ...
      >
        <h3 className="text-lg font-semibold text-viaduct-text-primary truncate">{name}</h3>
