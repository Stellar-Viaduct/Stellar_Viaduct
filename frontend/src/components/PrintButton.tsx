  ...
  return (
    <button
      ...
      className={[
        ...
        "border-viaduct-accent bg-viaduct-accent/10 px-4 py-2 text-sm font-medium",
        "text-viaduct-accent transition-colors hover:bg-viaduct-accent hover:text-white",
        "focus:outline-none focus:ring-2 focus:ring-viaduct-accent focus:ring-offset-2",
