...
export default function BridgeCard({ bridge, stats }: BridgeCardProps) {
  ...
  return (
    <Link
      ...
      className="block bg-viaduct-card border border-viaduct-border rounded-lg p-6 hover:border-viaduct-accent transition-colors focus:outline-none focus:ring-2 focus:ring-viaduct-accent focus:ring-offset-2 focus:ring-offset-stellar-dark"
    ...
    >
      ...
      <div className="space-y-3">
        <div className="flex justify-between">
          <span className="text-sm text-viaduct-text-secondary">Health Score</span>
        ...
        <div className="flex justify-between">
          <span className="text-sm text-viaduct-text-secondary">TVL</span>
        ...
        {stats && (
          <>
            <div className="flex justify-between">
              <span className="text-sm text-viaduct-text-secondary">24h Volume</span>
              <span className="text-sm text-white font-medium">
            ...
            <div className="flex justify-between">
              <span className="text-sm text-viaduct-text-secondary">24h Transactions</span>
              <span className="text-sm text-white font-medium">
        ...
        <div className="flex justify-between">
          <span className="text-sm text-viaduct-text-secondary">Supply Mismatch</span>
          <span
