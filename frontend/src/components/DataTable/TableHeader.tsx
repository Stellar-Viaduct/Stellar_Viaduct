  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-2">
        ...
        >
          <div className="flex items-center gap-2 text-viaduct-text-secondary">
            <span
            ...
            <span className="text-xs text-viaduct-text-secondary">{sortIndicator}</span>
            {canSort ? (
...
export function TableHeader<TData>({
  ...
  const headerContent = (
    <thead className="sticky top-0 bg-viaduct-card z-10">
      {headerGroups.map((hg) => (
        <tr
          key={hg.id}
          className="text-left text-viaduct-text-secondary border-b border-viaduct-border"
        >
