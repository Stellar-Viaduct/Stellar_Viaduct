...
export function ColumnFilter<TData>({
  ...
  if (filterType === "boolean") {
    ...
    return (
      <select
        className="mt-2 w-full bg-viaduct-background border border-viaduct-border rounded px-2 py-1 text-xs text-white"
  ...
  if (filterType === "numberRange") {
    ...
    return (
      <div className="mt-2 flex items-center gap-2">
        <input
          className="w-full bg-viaduct-background border border-viaduct-border rounded px-2 py-1 text-xs text-white"
          placeholder="Min"
          inputMode="decimal"
