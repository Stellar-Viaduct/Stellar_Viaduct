...
export default function ExternalDependencyPanel() {
  ...
  const headerActions = (
    <div className="flex flex-wrap gap-2">
      {summaryEntries.map(([label, count]) => (
        <span
          key={label}
          className="rounded-full border border-viaduct-border bg-viaduct-card px-3 py-1 text-xs text-viaduct-text-secondary"
        >
  ...
  return (
    <CollapsibleWidget
      ...
      defaultCollapsed={true}
      className="rounded-lg border border-viaduct-border bg-viaduct-card p-6"
    >
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
          {data.dependencies.map((dependency) => (
            <article
              ...
              className="rounded-lg border border-viaduct-border bg-black/15 p-4 space-y-3"
            >
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                <div className="rounded-md bg-stellar-border/30 px-3 py-2">
                  <p className="text-[11px] uppercase tracking-wide text-viaduct-text-secondary">
                    Last Latency
                  </p>
              ...
              <div className="flex flex-wrap gap-2 text-xs text-viaduct-text-secondary">
              ...
              {dependency.history && dependency.history.length > 0 && (
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-[11px] uppercase tracking-wide text-viaduct-text-secondary">
