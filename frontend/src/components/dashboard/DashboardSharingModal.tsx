  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div
        ...
        className="relative max-h-[90vh] w-full max-w-xl overflow-y-auto rounded-lg border border-viaduct-border bg-viaduct-background shadow-2xl shadow-black/40"
      >
        <div className="border-b border-viaduct-border bg-viaduct-card/80 px-5 py-4">
        ...
        <div className="space-y-5 p-5">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <label className="space-y-2 text-sm text-viaduct-text-secondary">
              ...
              <select
                ...
                className="w-full rounded-md border border-viaduct-border bg-viaduct-card px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-viaduct-accent"
              >
            ...
            <label className="flex items-center gap-3 rounded-lg border border-viaduct-border bg-viaduct-card p-3 text-sm text-viaduct-text-primary">
              <input
                type="checkbox"
          ...
          <div className="rounded-lg border border-viaduct-border bg-viaduct-card p-4">
            <p className="text-xs uppercase text-viaduct-text-secondary">Share link</p>
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              ...
              <a
                href={shareUrl}
                className="inline-flex min-h-9 items-center rounded-md border border-viaduct-border px-3 py-1.5 text-xs font-medium text-viaduct-text-secondary hover:border-viaduct-accent hover:text-white focus:outline-none focus:ring-2 focus:ring-viaduct-accent"
              >
                Open preview
              </a>
            </div>
