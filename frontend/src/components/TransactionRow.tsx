...
export default function TransactionRow({
  ...
  return (
    <tr
      onClick={() => onSelect(tx)}
      className="border-b border-viaduct-border hover:bg-stellar-border/30 cursor-pointer transition-colors"
    >
      {/* Status */}
      ...
      <td className="px-4 py-3">
        <div className="flex items-center gap-2">
          <span className="text-sm text-viaduct-accent font-mono">
      ...
      {/* Direction */}
      <td className="px-4 py-3">
        <div className="flex items-center gap-1 text-xs text-viaduct-text-secondary">
          <span>{tx.sourceChain}</span>
          <span className="text-viaduct-accent">&rarr;</span>
      ...
      <td className="px-4 py-3">
        <span
          className="text-sm text-viaduct-text-secondary"
...
export function TransactionCard({
  ...
  return (
    <button
      type="button"
      onClick={() => onSelect(tx)}
      className="w-full text-left bg-viaduct-card border border-viaduct-border rounded-lg p-4 hover:border-viaduct-accent transition-colors space-y-3"
    >
      ...
      <div className="flex items-center justify-between">
        ...
        <span className="text-xs text-viaduct-text-secondary">{tx.bridge}</span>
      </div>
      ...
      <div className="text-xs text-viaduct-accent font-mono">
        <div className="flex items-center gap-2">
