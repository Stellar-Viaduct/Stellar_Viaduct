 ...
 * Stellar Viaduct view. Import the variant that matches the page rather than
...
export function EmptyBridges({ hasFilters, onClearFilters }: EmptyBridgesProps) {
  ...
  return (
    <EmptyState
      ...
      description="Viaduct hasn't detected any bridges. Data is fetched from the Stellar network automatically — check back shortly."
...
export function EmptyConnection({ onRetry }: EmptyConnectionProps) {
  return (
    <EmptyState
      ...
      description="Viaduct can't reach the Stellar network right now. Check your connection and try again."
