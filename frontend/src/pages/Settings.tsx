    ...
    <div className="space-y-density">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
          <section
            className="rounded-xl border border-viaduct-border bg-viaduct-card p-6 space-y-4"
            aria-labelledby="settings-language-heading"
          >
            <h2
              id="settings-language-heading"
              className="text-lg font-semibold text-viaduct-text-primary"
            >
              {t("settings.language")}
            </h2>
          ...
          <section id="notifications" aria-labelledby="settings-notifications-heading">
            <h2
              ...
              className="text-xl font-semibold text-viaduct-text-primary mb-4 flex items-center gap-2"
            >
              <svg className="w-5 h-5 text-viaduct-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path
                  strokeLinecap="round"
          ...
          >
            <h2 id="settings-display-heading" className="text-lg font-semibold text-viaduct-text-primary">
              <span className="inline-flex items-center gap-2">
                {t("settings.displayTitle")}
                <HelpTooltip label={t("settings.displayHelp")} />
              </span>
            </h2>
            <p className="text-sm text-viaduct-text-secondary -mt-2">
            ...
            <label className="flex items-center justify-between gap-4 cursor-pointer">
              <span className="text-viaduct-text-secondary">
                ...
                <span className="block text-xs mt-1 text-viaduct-text-secondary/80">
            ...
            <label className="flex items-center justify-between gap-4 cursor-pointer">
              ...
              <select
                className="rounded-md border border-viaduct-border bg-viaduct-background px-3 py-1 text-sm text-white focus:outline-none focus:ring-2 focus:ring-viaduct-accent"
                value={density}
                onChange={(e) => {
          ...
          >
            <h2 id="settings-data-heading" className="text-lg font-semibold text-viaduct-text-primary">
              <span className="inline-flex items-center gap-2">
                ...
                <TabList aria-label="Data refresh interval" className="flex flex-wrap gap-2">
                  {refreshOptions.map((opt) => (
                    <Tab
                      key={opt.value}
                      id={String(opt.value)}
                      activeClassName="bg-viaduct-accent text-white border-viaduct-accent"
                      inactiveClassName="bg-viaduct-background text-viaduct-text-secondary hover:text-viaduct-text-primary border border-viaduct-border"
                    >
                      {opt.label}
                    </Tab>
                  ))}
          ...
          <section aria-labelledby="settings-dev-heading">
            ...
            <div className="bg-viaduct-card border border-viaduct-border rounded-lg p-6">
              <p className="text-sm text-viaduct-text-secondary mb-4">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-viaduct-accent/20 text-viaduct-accent border border-viaduct-accent/30 rounded-md hover:bg-viaduct-accent/30 transition-colors text-sm font-medium"
                >
        ...
        <div className="space-y-6">
          <div className="bg-viaduct-card border border-viaduct-border rounded-lg p-6">
            <h3 className="text-viaduct-text-primary font-medium mb-2">{t("settings.profileInfo")}</h3>
            <div className="flex items-center gap-4 mb-4">
              <div className="w-12 h-12 rounded-full bg-viaduct-accent flex items-center justify-center text-xl font-bold text-white">
                JS
              </div>
              <div>
                <p className="text-viaduct-text-primary font-medium">John Stellar</p>
                <p className="text-xs text-viaduct-text-secondary">Network Operator</p>
              </div>
            </div>
            <button
              type="button"
