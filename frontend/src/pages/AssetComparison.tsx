...
const MAX_COMPARE = 8;
const STORAGE_KEY = "stellar-viaduct:asset-comparison:v1";
      ...
      {selectedAssets.length > 0 && (
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="bg-viaduct-card border border-viaduct-border rounded-lg p-4">
            <p className="text-xs text-viaduct-text-secondary uppercase tracking-wide">Assets Selected</p>
            <p className="mt-1 text-2xl font-bold text-white">{selectedAssets.length}</p>
          </div>
          <div className="bg-viaduct-card border border-viaduct-border rounded-lg p-4">
            <p className="text-xs text-viaduct-text-secondary uppercase tracking-wide">Average Health</p>
            <p
          ...
          <div className="bg-viaduct-card border border-viaduct-border rounded-lg p-4">
            <p className="text-xs text-viaduct-text-secondary uppercase tracking-wide">Best / Worst</p>
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 mb-5">
          ...
          {selectedAssets.length > 0 && (
            <input
              ...
              className="rounded-lg border border-viaduct-border bg-viaduct-background px-3 py-2 text-sm text-white placeholder:text-stellar-text-muted focus:outline-none focus:ring-2 focus:ring-viaduct-accent w-full sm:w-56"
