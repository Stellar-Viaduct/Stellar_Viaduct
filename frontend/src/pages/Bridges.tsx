...
export default function Bridges() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        <h1 className="text-3xl font-bold text-viaduct-text-primary">Bridges</h1>
      ...
      <div className="flex flex-wrap items-center justify-end gap-3">
        ...
        <button
          ...
          className="rounded-md border border-viaduct-border px-4 py-2 text-sm text-white hover:bg-stellar-border"
        >
          Refresh now
        </button>
      </div>
      ...
      <div className="bg-viaduct-card border border-viaduct-border rounded-lg p-6">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody className="text-viaduct-text-primary">
              <tr>
                <td colSpan={5} className="py-6 text-center text-viaduct-text-secondary">
