    ...
    <div className="space-y-8">
      ...
      <section className="grid gap-6 xl:grid-cols-[1.1fr,0.9fr]">
        <form
          ...
          className="rounded-3xl border border-viaduct-border bg-viaduct-card/80 p-6"
        >
          <div className="flex items-start justify-between gap-4">
            ...
            <span className="rounded-full border border-viaduct-border px-3 py-1 text-xs uppercase tracking-[0.2em] text-viaduct-text-secondary">
              Secure flow
            </span>
          </div>
        ...
        <section className="rounded-3xl border border-viaduct-border bg-viaduct-card/80 p-6">
          <div className="flex items-start justify-between gap-4">
            <div>
            ...
            <button
              ...
              className="rounded-full border border-viaduct-border px-4 py-2 text-sm text-viaduct-text-secondary transition hover:border-viaduct-accent hover:text-white"
            >
              Refresh
            </button>
          </div>
          ...
          <div className="mt-6 space-y-4">
            ...
            {keys.map((key) => (
              <article
                key={key.id}
                className="rounded-2xl border border-viaduct-border bg-viaduct-background/70 p-4"
              >
