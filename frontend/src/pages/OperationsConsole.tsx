...
import type { ActionDef } from "../components/ops/ActionShortcutButton";
...
function OperationsConsole() {
  ...
  const handleExecute = async (action: typeof ACTIONS[0]) => {
...
function ActionWrapper({ action, onExecute }: { action: typeof ACTIONS[0]; onExecute: (a: typeof ACTIONS[0]) => void }) {
  return (
