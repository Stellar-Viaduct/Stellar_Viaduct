    ...
    <div className="space-y-8">
      <header className="flex flex-wrap items-start justify-between gap-4">
        ...
        <button
          ...
          className="rounded-lg bg-viaduct-accent px-5 py-2.5 text-sm font-semibold text-white hover:bg-viaduct-accent/90 transition-colors focus:outline-none focus:ring-2 focus:ring-viaduct-accent"
