...
const translations = {
  es: {
    ...
    dashboard: {
      title: "Panel",
      welcome: "Bienvenido a Stellar Viaduct",
  ...
  fr: {
    ...
    dashboard: {
      ...
      welcome: "Bienvenue sur Stellar Viaduct",
  ...
  de: {
    ...
    dashboard: {
      title: "Dashboard",
      welcome: "Willkommen bei Stellar Viaduct",
  ...
  ko: {
    ...
    dashboard: {
      title: "대시보드",
      welcome: "Stellar Viaduct에 오신 것을 환영합니다",
      assetOverview: "자산 개요",
      bridgeStatus: "브릿지 상태",
      recentAlerts: "최근 알림",
      priceCharts: "가격 차트",
  ...
  ar: {
    ...
    dashboard: {
      title: "لوحة التحكم",
      welcome: "مرحبًا بك في Stellar Viaduct",
