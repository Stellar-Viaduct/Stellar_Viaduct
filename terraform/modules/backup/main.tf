...
resource "aws_iam_role" "backup" {
  name = "stellar-viaduct-${var.environment}-backup-role"
...
resource "aws_backup_vault" "main" {
  name = "stellar-viaduct-${var.environment}-backup-vault"
...
resource "aws_backup_plan" "main" {
  name = "stellar-viaduct-${var.environment}-backup-plan"
...
resource "aws_backup_selection" "main" {
  ...
  name         = "stellar-viaduct-${var.environment}-backup-selection"
