...
This implementation provides a comprehensive CI/CD pipeline for Stellar Viaduct using GitHub Actions, covering automated testing, building, security scanning, and deployment automation.
...
- Name: `staging`
- URL: `https://staging.stellarviaduct.io`
- Protection: None (auto-deploy)

**Production:**

- Name: `production`
- URL: `https://stellarviaduct.io`
...
```markdown
[![CI](https://github.com/Stellar_Viaduct/Stellar_Viaduct/actions/workflows/ci.yml/badge.svg)](https://github.com/Stellar_Viaduct/Stellar_Viaduct/actions/workflows/ci.yml)
[![Security](https://github.com/Stellar_Viaduct/Stellar_Viaduct/actions/workflows/security.yml/badge.svg)](https://github.com/Stellar_Viaduct/Stellar_Viaduct/actions/workflows/security.yml)
[![Deploy](https://github.com/Stellar_Viaduct/Stellar_Viaduct/actions/workflows/deploy.yml/badge.svg)](https://github.com/Stellar_Viaduct/Stellar_Viaduct/actions/workflows/deploy.yml)
[![Code Quality](https://github.com/Stellar_Viaduct/Stellar_Viaduct/actions/workflows/code-quality.yml/badge.svg)](https://github.com/Stellar_Viaduct/Stellar_Viaduct/actions/workflows/code-quality.yml)
```
