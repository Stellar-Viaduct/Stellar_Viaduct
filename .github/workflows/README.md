...
This directory contains the CI/CD pipeline configuration for Stellar Viaduct.
...
- **Staging**: `https://staging.stellarviaduct.io`
- **Production**: `https://stellarviaduct.io` (requires manual approval)
